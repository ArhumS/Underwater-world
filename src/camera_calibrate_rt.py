...
# Underwater-world/src/camera_calibrate.py
import json
import numpy as np
import cv2
import glob
...
# rot and translational vectors

        print 'Rotational vecs1', self.r1
        print 'Rotational vecs2', self.r2
        print 'Translational vecs1', self.t1
        print 'translational vecs2', self.t2
